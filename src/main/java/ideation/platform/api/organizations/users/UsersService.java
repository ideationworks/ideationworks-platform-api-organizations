...
import ideation.platform.api.organizations.OrganizationsService;
...
public class UsersService {
    ...
    public Optional<User> updateUserByPrincipal(UUID uuid, User user, Principal principal) {

        Optional<User> principalUser = getByPrincipalOrganizationAndId(principal, uuid);

        if (principalUser.isPresent()) {

            Optional<User> optionalUser = getByPrincipalOrganizationAndId(principal, uuid);
            ...
            if (optionalUser.isPresent()) {
                ...
                if (user.getIsAdmin() != null) {
                    ...
                    optionalUser.get().setIsAdmin(user.getIsAdmin());
                ...
                if (user.getStatus() != null) {
                    ...
                    optionalUser.get().setStatus(user.getStatus());

                }

                if (user.getDescription() != null) {

                    optionalUser.get().setDescription(user.getDescription());
    ...
    public Optional<User> getByPrincipalOrganizationAndId(Principal principal, UUID uuid) {

        Optional<User> principalUser = getPrincipalUser(principal);

        if (principalUser.isPresent()) {

//            return usersRepository.getByUuidAndOrganization(uuid, principalUser.get().getOrganization());
