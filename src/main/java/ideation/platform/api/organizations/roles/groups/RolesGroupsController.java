...
import ideation.platform.api.organizations.roles.RolesRepository;
...
//    }
    ...
    public ResponseEntity<?> assignRoleToGrouyp(@PathVariable("roleGroupId") Long roleGroupId, @PathVariable("roleId") Long roleId) {
